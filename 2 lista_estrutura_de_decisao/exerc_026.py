...
peso_quilos = float(input('Informe o peso em quilo: '))
codigo_pais = int(input('Informe o código do País: '))

peso_em_gramas = peso_quilos * 1000
print('O peso do produto convertido em gramas é de:',peso_em_gramas) 
...
print('O preço total do produto comprado é:',preco_total)
