...
"""
salario_minimo = float(input('Digite o salário minímo: '))
turno = str(input('Informe o turno: '))
categoria = str(input('Informe a categoria: '))
numero_de_horas_trabalhadas = float(input('Informe o número de horas trabalhadas no mês: ')) 
...
print('O coeficiente é:',coeficiente)
salario_bruto = numero_de_horas_trabalhadas * coeficiente
print('O salário será de:',salario_bruto)
...
print(f'O auxílio será de: {auxilio:.2f}')
salario_liquido = salario_bruto - imposto + gratificacao + auxilio
print(f'O salário líquido será: {salario_liquido:.2f}')
