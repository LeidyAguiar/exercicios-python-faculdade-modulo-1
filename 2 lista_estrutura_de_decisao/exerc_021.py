"""
21. Faça um programa que receba o valor do salário mínimo, o número de horas trabalhadas, o número de dependentes do funcionário e a quantidade de horas extras trabalhadas. 
...
"""
salario_minimo = float(input('Informe o seu salário: '))
numero_horas_trabalhadas = float(input('Informe o número de horas trabalhadas: '))
